...
- Added auto-complete for tuning and string references in the current project.
- Added CMD/CTRL-click to jump to string table from a key string in XML files.
### Changed
